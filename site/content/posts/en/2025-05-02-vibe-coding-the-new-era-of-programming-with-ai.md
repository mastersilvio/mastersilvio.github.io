---
title: 'Vibe Coding - The New Era of Programming with AI'
description: 'Vibe Coding is an emerging approach to programming that uses large language models (LLMs) to generate code from natural-language instructions. This lets developers, even without deep technical kno'
pubDate: 2025-05-02
tags: ['Technology', 'AI', 'Development']
lang: 'en'
slug: 'vibe-coding-the-new-era-of-programming-with-ai-en'
translatedPosts:
  pt: 'vibe-coding-a-nova-era-da-programacao-com-ia-pt'
  es: 'vibe-coding-la-nueva-era-de-la-programacion-con-ia-es'
---
...
The term was coined by **Andrej Karpathy**, OpenAI co-founder and former Tesla AI director, in February 2025. Karpathy described this approach as useful for quick projects or prototypes, acknowledging AI may not understand or fix every bug, requiring user experimentation. Source: [Y Combinator](https://www.ycombinator.com/library/ME-vibe-coding-is-the-future)
